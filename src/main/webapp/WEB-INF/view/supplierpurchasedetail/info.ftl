            ...
            <div class="modal-content">
                  ...
                  <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                     	 ...
                     	 <label class="col-sm-3 control-label">purchasedetailid：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="purchasedetailid" placeholder="请输入purchasedetailid" class="form-control"  value="<#if data??><#if data.purchasedetailid??>${data.purchasedetailid}</#if></#if>"> 
                  ...
                  <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="MyFun.objSave('save_form','${request.contextPath}/supplierpurchasedetail/save.do','refreshSupplierPurchaseDetailList')">保存</button>
             	</div>
          	 	</form>
            </div>
        </div>
