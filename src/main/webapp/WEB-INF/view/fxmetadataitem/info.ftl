        ...
        <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                     	 ...
                     	 <label class="col-sm-3 control-label">condition：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="condition" placeholder="请输入condition" class="form-control"  value="<#if data??><#if data.condition??>${data.condition}</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
	   				    <div class="form-group">
                     	 <label class="col-sm-3 control-label">message：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="message" placeholder="请输入message" class="form-control"  value="<#if data??><#if data.message??>${data.message}</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
	   				    <div class="form-group">
                     	 <label class="col-sm-3 control-label">parameter：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="parameter" placeholder="请输入parameter" class="form-control"  value="<#if data??><#if data.parameter??>${data.parameter}</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                  ...
                  <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="MyFun.objSave('save_form','${request.contextPath}/fxmetadataitem/save.do','refreshFxMetadataitemList')">保存</button>
             	</div>
          	 	</form>
            </div>
        </div>
