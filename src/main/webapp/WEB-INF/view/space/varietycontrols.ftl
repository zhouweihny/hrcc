...
#OrderList.dataTable tbody tr td:last-child a, #OrderList.dataTable tbody tr td .J_checkdrug {
    display: block;
}
#OrderList.dataTable tbody tr td:last-child a:hover, #OrderList.dataTable tbody tr td .J_checkdrug:hover {
                ...
                <div class="ibox-content">
                    <form class="form-inline" id="J_formSearch" action="javascript:;">
                        ...
                        <div class="row fn-mt-15">
                            ...
                            <div class="form-group col-md-3">
                                <input type="hidden" class="form-control" placeholder="显示对码品种" name="showcompared" id="showcompared" value="true">
                                <input type="hidden" class="form-control" placeholder="显示对码品种" name="compared" value="0">
                                <button type="button" class="btn btn-w-m btn-info" id="J_searchBtn"><i class="fa fa-search"></i>查 询</button>
                            </div>
                        </div>
                    </form>
                    <div class="m-t">
...
function exportFile(){
    if(curSpaceid && curCatalogid){
        var  url= "${request.contextPath}/space/exportfile.do?checked=true&spaceid="+curSpaceid+"&catalogid="+curCatalogid;
        ...
                },
                {
                    "render": function(data, type, row) {
                        ...
                        if(row.checked==true){
                            ...
                            if(row.compared == 0)
                                buffer = '<a href="javascript:;" class="J_checkdrug">复核</a>';
                        }
                        return buffer;
                    },
                    "targets": 6
                },
                {
                    "render": function(data, type, row) {
                        ...
                        if(row.compared == 0){
                            buffer.push('<a href="javascript:;" class="J_delCheck">删除对码</a>');
                        }
