        ...
        <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="MyFun.objSave('save_form','${request.contextPath}/purchasedetail/save.do','refreshPurchaseDetailList')">保存</button>
             	</div>
          	 	</form>
            </div>
        </div>
