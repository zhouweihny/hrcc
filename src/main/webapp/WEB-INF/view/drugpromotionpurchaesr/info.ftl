        ...
        <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                     	 ...
                     	 <label class="col-sm-3 control-label">promotionid：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="promotionid" placeholder="请输入promotionid" class="form-control"  value="<#if data??><#if data.promotionid??>${data.promotionid}</#if></#if>"> 
                  ...
                  <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="MyFun.objSave('save_form','${request.contextPath}/drugpromotionpurchaesr/save.do','refreshDrugPromotionPurchaesrList')">保存</button>
             	</div>
          	 	</form>
            </div>
        </div>
