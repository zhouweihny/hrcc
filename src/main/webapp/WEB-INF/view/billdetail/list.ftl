        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="J_gobackwrap">
                    ...
                    <h4><@_bill id=billid>${bill.no!""}</@_bill></h4>
                </div>
                    <div class="ibox-content">
                    <form class="form-inline row" id="J_formSearch" action="javascript:;">
                        <input type="hidden" name="billid" value="${billid}"/>
                    </form>
                    <div id="BillDetailList" data-url="${request.contextPath}/billdetail/table.do">
                    </div>    
                   </div>
              </div>
                </div>
...
<script>
  ...
  function refreshBillDetailList(){
   	MyFun.ajaxRefreshTable("BillDetailList");
  }

  $(function(){
      MyFun.search('J_formSearch','BillDetailList');
  })
</script>
</body>
</html>
