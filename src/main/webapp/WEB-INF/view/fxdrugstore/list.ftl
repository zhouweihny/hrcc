                ...
                <div class="ibox float-e-margins">
                    ...
                    <form class="form-inline row" id="J_formSearch" action="javascript:;">
                        ...
                        <div class="form-group col-md-2">
                            <button type="button" class="btn btn-w-m btn-info" onclick="MyFun.search('J_formSearch','FxDrugStoreList');"><i class="fa fa-search"></i>查 询</button>
                        </div>
                    </form>
                    <div class="m-t">
                         <a data-toggle="modal" class="btn btn-primary"   data-target="#info-form" onclick="javascript:MyFun.appendAjaxHtml('${request.contextPath}/fxdrugstore/byid.do','info-form')">新增</a>
                    </div>
                    <div id="FxDrugStoreList" data-url="${request.contextPath}/fxdrugstore/table.do">
                    </div>    
                   </div>
              </div>
                </div>
...
<script>
  ...
  function refreshFxDrugStoreList(){
   	MyFun.ajaxRefreshTable("FxDrugStoreList");
  }
