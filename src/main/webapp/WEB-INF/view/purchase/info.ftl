        ...
        <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                     	 ...
                     	 <label class="col-sm-3 control-label">remark：</label>
	   				    ...
	   				    <div class="form-group">
                     	 <label class="col-sm-3 control-label">iremark：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="iremark" placeholder="请输入iremark" class="form-control"  value="<#if data??><#if data.iremark??>${data.iremark}</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
	   				    <div class="form-group">
                  ...
                  <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="MyFun.objSave('save_form','${request.contextPath}/purchase/save.do','refreshPurchaseList')">保存</button>
             	</div>
          	 	</form>
            </div>
        </div>
