            ...
            <div class="modal-content">
                  ...
                  <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                     	 ...
                     	 <label class="col-sm-3 control-label">wxuserid：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="wxuserid" placeholder="请输入wxuserid" class="form-control"  value="<#if data??><#if data.wxuserid??>${data.wxuserid}</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
	   				    <div class="form-group">
                     	 <label class="col-sm-3 control-label">qrscene：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="qrscene" placeholder="请输入qrscene" class="form-control"  value="<#if data??><#if data.qrscene??>${data.qrscene}</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
	   				    <div class="form-group">
                  ...
                  <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="MyFun.objSave('save_form','${request.contextPath}/syswxuserqrcode/save.do','refreshSysWxUserQrcodeList')">保存</button>
             	</div>
          	 	</form>
            </div>
        </div>
