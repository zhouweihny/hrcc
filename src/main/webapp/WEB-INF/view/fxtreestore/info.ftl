        ...
        <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                     	 ...
                     	 <label class="col-sm-3 control-label">parentid：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="parentid" placeholder="请输入parentid" class="form-control"  value="<#if data??><#if data.parentid??>${data.parentid}</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
	   				    <div class="form-group">
                     	 <label class="col-sm-3 control-label">path：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="path" placeholder="请输入path" class="form-control"  value="<#if data??><#if data.path??>${data.path}</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
	   				    <div class="form-group">
                  ...
                  <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="MyFun.objSave('save_form','${request.contextPath}/fxtreestore/save.do','refreshFxTreeStoreList')">保存</button>
             	</div>
          	 	</form>
            </div>
        </div>
