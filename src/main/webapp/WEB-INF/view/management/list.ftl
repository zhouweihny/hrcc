            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="m-t">
                        ...
                        <a class="J_demoDownload" href="${request.contextPath}/managementDemo.xls" target="_blank">示例下载</a>
                        <a class="J_demoDownload" href="javascript:;" id="J_demoImgShwo">示例图片查看</a>
                        <div id="J_demoImg" class="fn-hide" ><img src="${request.contextPath}/managementDemo.png"></div>
                        <span class="ztips">（请按照示例表格格式上传数据！）</span>
                    </div>
                    <div id="DrugList" data-url="${request.contextPath}/management/table.do"></div>    
                </div>
            </div>
        </div>
    </div>
...
function initExcelUpload(){
    ...
    var uploader = WebUploader.create({
        ...
        // 文件接收服务端。
        server: "${request.contextPath}/management/uploadxls.do",
        // 选择文件的按钮。可选。
