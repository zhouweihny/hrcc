...
<table class="table table-striped table-bordered table-hover dataTables-example dataTable" id="DrugList" aria-describedby="DataTables_Table_0_info">
	...
	<tr class="gradeX">
		...
		<td>${a.costprice!""}</td>
		<td>${a.price!""}</td>
		<td>	<a href="javascript:;" onclick="bindComoname(this);" data-id='${a.id!""}' data-code='${a.code!""}' data-name='${a.name!""}' data-specifications='${a.specifications!""}' data-unit='${a.unit!""}' data-dosageform='${a.dosageform!""}' data-factory='${a.factory!""}'>通用名绑定</a>
		</td>
    </tr>
    </#list> 
    </tbody>
