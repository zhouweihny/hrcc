        ...
        <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                     	 ...
                     	 <label class="col-sm-3 control-label">price：</label>
	   				    ...
	   				    <div class="form-group">
                     	 <label class="col-sm-3 control-label">bizdate：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="bizdate" placeholder="请输入bizdate" class="form-control"  value="<#if data??><#if data.bizdate??>${(data.bizdate?string("yyyy-MM-dd HH:mm"))!  
                                     }</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                  ...
                  <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="MyFun.objSave('save_form','${request.contextPath}/fximpsaledata/save.do','refreshFxImpsaledataList')">保存</button>
             	</div>
          	 	</form>
            </div>
        </div>
