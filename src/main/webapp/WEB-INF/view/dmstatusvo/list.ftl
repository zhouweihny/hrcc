                ...
                <div class="ibox float-e-margins">
                    ...
                    <form class="form-inline row" id="J_formSearch" action="javascript:;">
                      	<div class="form-group col-md-3">
                            <label for="J_name">对码项目：</label>
                             <@select id="spaceid" datas=spaces      key="id" text="name"/>
                        </div>
                        <div class="form-group col-md-2">
                            <button type="button" class="btn btn-w-m btn-info" onclick="MyFun.search('J_formSearch','DmStatusVoList');"><i class="fa fa-search"></i>查 询</button>
                        </div>
                    </form>
                    <div id="DmStatusVoList" data-url="${request.contextPath}/dmstatusvo/table.do">
                    </div>    
                   </div>
              </div>
                </div>
...
<script>
  ...
  function refreshDmStatusVoList(){
   	MyFun.ajaxRefreshTable("DmStatusVoList");
  }

  $(function(){
  	 MyFun.search('J_formSearch','DmStatusVoList');
  })
</script>
</body>
</html>
