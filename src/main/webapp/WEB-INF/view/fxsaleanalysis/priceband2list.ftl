...
function getDetail(){
    ...
    $.PostJson("${request.contextPath}/fxsaleanalysis/priceband2.do", "storeid="+p_getStoreId+"&startdate="+startdate+"&enddate="+enddate, function(state, json){
        if(state == 'success'){
