                ...
                <div class="ibox float-e-margins">
                    ...
                    <form class="form-inline row" id="J_formSearch" action="javascript:;">
                        ...
                        <div class="form-group col-md-2">
                            <button type="button" class="btn btn-w-m btn-info" onclick="MyFun.search('J_formSearch','SysWxMsgList');"><i class="fa fa-search"></i>查 询</button>
                        </div>
                    </form>
                    <div class="m-t">
                    	 <a data-toggle="modal" class="btn btn-primary"   data-target="#info-form" onclick="javascript:MyFun.appendAjaxHtml('${request.contextPath}/syswxmsg/byid.do','info-form')">新增</a> 
                        <!--    <a data-toggle="modal" data-backdrop="static" class="btn btn-primary"   data-target="#info-form" onclick="javascript:MyFun.appendAjaxHtml('${request.contextPath}/zhtml/tuwen_edit.html','info-form')">新增</a>-->
                    </div>
                    <div id="SysWxMsgList" data-url="${request.contextPath}/syswxmsg/table.do">
                    </div>    
                   </div>
              </div>
                </div>
...
<script>
  ...
  function refreshSysWxMsgList(){
   	MyFun.ajaxRefreshTable("SysWxMsgList");
  }
