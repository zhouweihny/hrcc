        ...
        <div class="modal-dialog">
            <div class="modal-content">
                    ...
                    <div class="ibox-content">
                         ...
                         <div class="form-group">
                     	 <label class="col-sm-3 control-label">类型：</label>
                                <div class="col-sm-8">
                                <#if data??>
                                    <@dictSelect  id="type" code="wx.msg.type" defaultValue="${data.type!''}"/>
                                 <#else>   
                                    <@dictSelect  id="type" code="wx.msg.type" />
                                </#if>    
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>    
                  ...
                  <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="MyFun.objSave('save_form','${request.contextPath}/syswxmsg/save.do','refreshSysWxMsgList')">保存</button>
             	</div>
          	 	</form>
            </div>
        </div>
