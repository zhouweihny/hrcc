        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-inline fn-hide" id="J_formSearch" action="javascript:;">
                        <div class="row">
...
function getzPageS(){
    ...
    $.PostJson("${request.contextPath}/fxdrugtype/storereportjson.do", 'storeid='+curStoreid+'&salefile='+curSaleFile, function(state, json){
        if(state == 'success'){
            if(json && json.code == '0000'){
                ...
                MyFun.to.e(json.message || "查询库存失败");
    ...
    if(zuiTbl){
        ...
        zuiTbl = $('#OrderList').DataTable( {
            ...
            ajax: function (data, callback, settings) {
                ...
                $.ajax({
                    type: "post",
                    url: "${request.contextPath}/fxdrugtype/storereportjson.do",
                    cache: false,  //禁用缓存
