        ...
        <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                     	 ...
                     	 <label class="col-sm-3 control-label">startdate：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="startdate" placeholder="请输入startdate" class="form-control"  value="<#if data??><#if data.startdate??>${(data.startdate?string("yyyy-MM-dd HH:mm"))!  
                                     }</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
	   				    <div class="form-group">
                     	 <label class="col-sm-3 control-label">endate：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="endate" placeholder="请输入endate" class="form-control"  value="<#if data??><#if data.endate??>${(data.endate?string("yyyy-MM-dd HH:mm"))!  
                                     }</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                     	 ...
                     	 <label class="col-sm-3 control-label">num：</label>
	   				    ...
	   				    <div class="form-group">
                     	 <label class="col-sm-3 control-label">processed：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="processed" placeholder="请输入processed" class="form-control"  value="<#if data??><#if data.processed??>${data.processed}</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
	   				    <div class="form-group">
                     	 <label class="col-sm-3 control-label">error：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="error" placeholder="请输入error" class="form-control"  value="<#if data??><#if data.error??>${data.error}</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
	   				    <div class="form-group">
                     	 <label class="col-sm-3 control-label">status：</label>
	   				    ...
	   				    <div class="form-group">
                     	 <label class="col-sm-3 control-label">filepath：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="filepath" placeholder="请输入filepath" class="form-control"  value="<#if data??><#if data.filepath??>${data.filepath}</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
	   				    <div class="form-group">
                     	 <label class="col-sm-3 control-label">errorpath：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="errorpath" placeholder="请输入errorpath" class="form-control"  value="<#if data??><#if data.errorpath??>${data.errorpath}</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
	   				    <div class="form-group">
                  ...
                  <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="MyFun.objSave('save_form','${request.contextPath}/fxsalefile/save.do','refreshFxSaleFileList')">保存</button>
             	</div>
          	 	</form>
            </div>
        </div>
