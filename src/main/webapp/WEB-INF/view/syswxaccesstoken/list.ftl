                ...
                <div class="ibox float-e-margins">
                    ...
                    <form class="form-inline row" id="J_formSearch" action="javascript:;">
                        ...
                        <div class="form-group col-md-2">
                            <button type="button" class="btn btn-w-m btn-info" onclick="MyFun.search('J_formSearch','SysWxAccesstokenList');"><i class="fa fa-search"></i>查 询</button>
                        </div>
                    </form>
                    <div id="SysWxAccesstokenList" data-url="${request.contextPath}/syswxaccesstoken/table.do">
                    </div>    
                   </div>
              </div>
                </div>
...
<script>
  ...
  function refreshSysWxAccesstokenList(){
   	MyFun.ajaxRefreshTable("SysWxAccesstokenList");
  }
