                ...
                <div class="ibox float-e-margins">
                    ...
                    <form class="form-inline row" id="J_formSearch" action="javascript:;">
                        ...
                        <div class="form-group col-md-2">
                            <button type="button" class="btn btn-w-m btn-info" onclick="MyFun.search('J_formSearch','SysWxUserList');"><i class="fa fa-search"></i>查 询</button>
                        </div>
                    </form>
                    <div id="SysWxUserList" data-url="${request.contextPath}/syswxuser/table.do">
                    </div>    
                   </div>
              </div>
                </div>
...
<script>
  function refreshSysWxUserList(){
   	MyFun.ajaxRefreshTable("SysWxUserList");
  }
