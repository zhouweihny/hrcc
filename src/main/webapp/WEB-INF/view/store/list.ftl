                ...
                <div class="ibox float-e-margins">
                    ...
                    <form class="form-inline row" id="J_formSearch" action="javascript:;">
                       ...
                       <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" id="J_name" placeholder="输入名称" name="storecode">
                        </div>
                        
                        <div class="form-group col-md-2">
                            <button type="button" class="btn btn-w-m btn-info" onclick="MyFun.search('J_formSearch','StoreList');"><i class="fa fa-search"></i>查 询</button>
                        </div>
                    </form>
                    <div class="m-t">
                         <a data-toggle="modal" class="btn btn-primary"   data-target="#info-form" onclick="javascript:MyFun.appendAjaxHtml('${request.contextPath}/store/byid.do','info-form')">新增</a>
                    </div>
                    <div id="StoreList" data-url="${request.contextPath}/store/table.do">
                    </div>    
                   </div>
              </div>
                </div>
...
<script>
  ...
  function refreshStoreList(){
   	MyFun.ajaxRefreshTable("StoreList");
  }
