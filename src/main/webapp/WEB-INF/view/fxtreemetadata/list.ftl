                ...
                <div class="ibox float-e-margins">
                    ...
                    <form class="form-inline row" id="J_formSearch" action="javascript:;">
                        ...
                        <div class="form-group col-md-2">
                            <button type="button" class="btn btn-w-m btn-info" onclick="MyFun.search('J_formSearch','FxTreeMetaDataList');"><i class="fa fa-search"></i>查 询</button>
                        </div>
                    </form>
                    <div class="m-t">
                         <a data-toggle="modal" class="btn btn-primary"   data-target="#info-form" onclick="javascript:MyFun.appendAjaxHtml('${request.contextPath}/fxtreemetadata/byid.do','info-form')">新增</a>
                    </div>
                    <div id="FxTreeMetaDataList" data-url="${request.contextPath}/fxtreemetadata/table.do">
                    </div>    
                   </div>
              </div>
                </div>
...
<script>
  ...
  function refreshFxTreeMetaDataList(){
   	MyFun.ajaxRefreshTable("FxTreeMetaDataList");
  }
