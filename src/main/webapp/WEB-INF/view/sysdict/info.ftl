            ...
            <div class="modal-content">
                  ...
                  <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5><#if sysDict??>编辑<#else>新增</#if></h5>
                    ...
                    <div class="ibox-content">
                     	 ...
                     	 <label class="col-sm-3 control-label">编码：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="code" placeholder="请输入编码" class="form-control"  value="<#if data??><#if data.code??>${data.code}</#if></#if>"> 
                  ...
                  <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="MyFun.objSave('save_form','${request.contextPath}/sysdict/save.do','refreshSysDictList')">保存</button>
             	</div>
          	 	</form>
            </div>
        </div>
