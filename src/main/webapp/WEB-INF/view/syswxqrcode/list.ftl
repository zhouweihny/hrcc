...
<head>
    ...
    <script src="${request.contextPath}/js/plugins/select2/js/select2.min.js"></script>
    <script src="${request.contextPath}/js/plugins/select2/js/i18n/zh-CN.js"></script>
    <link href="${request.contextPath}/js/plugins/select2/css/select2.min.css" rel="stylesheet">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <form class="form-inline row" id="J_formSearch" action="javascript:;">
                        <div class="form-group col-md-3">
                            ...
                            <@_syswxlist>
 									<@select id="wxid" datas=sysWxs key="id" text="name" headKey="" headText="所有" />
  							</@_syswxlist>                    
                        </div>
                        <div class="form-group col-md-2">
                            <button type="button" class="btn btn-w-m btn-info" onclick="MyFun.search('J_formSearch','SysWxQrcodeList');"><i class="fa fa-search"></i>查 询</button>
                        </div>
                    </form>
                    <div class="m-t">
                         <a data-toggle="modal" class="btn btn-primary"   data-target="#info-form" onclick="javascript:MyFun.appendAjaxHtml('${request.contextPath}/syswxqrcode/byid.do','info-form')">新增</a>
                    </div>
                    <div id="SysWxQrcodeList" data-url="${request.contextPath}/syswxqrcode/table.do">
                    </div>    
                   </div>
              </div>
                </div>
...
<script>
  ...
  function refreshSysWxQrcodeList(){
   	MyFun.ajaxRefreshTable("SysWxQrcodeList");
  }
