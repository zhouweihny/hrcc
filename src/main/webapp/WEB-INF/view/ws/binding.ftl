...
srvMap.add("sendcode", "success.json", "${request.contextPath}/ws/sendcode.do");//获取验证码
srvMap.add("bindClerk", "success.json", "${request.contextPath}/ws/verifycode.do");//绑定
srvMap.add("banduser", "success.json", "${request.contextPath}/ws/banduser.do");//绑定
