...
<div class="item" data-id='${item.id!""}' data-arrivaltime='<#if item.arrivaltime ??>${item.arrivaltime?string("yyyy-MM-dd")}</#if>' data-status='${item.status!""}'>
    ...
    <div class="weui-panel__bd">
        <div class="weui-media-box__bd">
            <div class="weui-media-box__desc">
                ...
                <div class="weui-flex">
                    <div class="item_r">
                        <p class="des"><span>采购商</span>：</p>
                    </div>
                    <div class="weui-flex__item">
                        <p class="detail"><#if item.purchaserid?? ><@_user id=item.purchaserid>${user.company!""}</@_user></#if></p>
                    </div>
                </div>
                <div class="weui-flex">
                    <div class="item_r">
