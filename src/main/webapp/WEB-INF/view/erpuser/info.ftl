        ...
        <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                     	 ...
                     	 <label class="col-sm-3 control-label">username：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="username" placeholder="请输入username" class="form-control"  value="<#if data??><#if data.username??>${data.username}</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
	   				    <div class="form-group">
                  ...
                  <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="MyFun.objSave('save_form','${request.contextPath}/erpuser/save.do','refreshErpuserList')">保存</button>
             	</div>
          	 	</form>
            </div>
        </div>
