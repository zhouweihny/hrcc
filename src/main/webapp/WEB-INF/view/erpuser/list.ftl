                ...
                <div class="ibox float-e-margins">
                    ...
                    <form class="form-inline row" id="J_formSearch" action="javascript:;">
                        ...
                        <div class="form-group col-md-2">
                            <button type="button" class="btn btn-w-m btn-info" onclick="MyFun.search('J_formSearch','ErpuserList');"><i class="fa fa-search"></i>查 询</button>
                        </div>
                    </form>
                    <div class="m-t">
                         <a data-toggle="modal" class="btn btn-primary"   data-target="#info-form" onclick="javascript:MyFun.appendAjaxHtml('${request.contextPath}/erpuser/byid.do','info-form')">新增</a>
                    </div>
                    <div id="ErpuserList" data-url="${request.contextPath}/erpuser/table.do">
                    </div>    
                   </div>
              </div>
                </div>
...
<script>
  ...
  function refreshErpuserList(){
   	MyFun.ajaxRefreshTable("ErpuserList");
  }
