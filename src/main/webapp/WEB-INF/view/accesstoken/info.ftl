        ...
        <div class="modal-dialog">
            <div class="modal-content">
                  ...
                  <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                     	 ...
                     	 <label class="col-sm-3 control-label">userid：</label>
	   				    ...
	   				    <div class="form-group">
                     	 <label class="col-sm-3 control-label">accesstoken：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="accesstoken" placeholder="请输入accesstoken" class="form-control"  value="<#if data??><#if data.accesstoken??>${data.accesstoken}</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
	   				    <div class="form-group">
                     	 <label class="col-sm-3 control-label">expirytime：</label>
                                <div class="col-sm-8">
                                    <input type="text" name="expirytime" placeholder="请输入expirytime" class="form-control"  value="<#if data??><#if data.expirytime??>${(data.expirytime?string("yyyy-MM-dd HH:mm"))!  
                                     }</#if></#if>"> 
                                    <span class="help-block m-b-none"></span>
                                </div>
                            </div>
                  ...
                  <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-primary" onclick="MyFun.objSave('save_form','${request.contextPath}/accesstoken/save.do','refreshAccesstokenList')">保存</button>
             	</div>
          	 	</form>
            </div>
        </div>
