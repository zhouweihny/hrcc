...
table.J_dataTbl thead .sorting:after {
    content: "\f0dc";
    float: right;
    font-family: fontawesome;
    color: rgba(50, 50, 50, 0.5);
}
table.J_dataTbl thead .sorting_desc:after {
    content: "\f0dd";
    float: right;
    font-family: fontawesome;
}
table.J_dataTbl thead .sorting_asc:after {
    content: "\f0d8";
    float: right;
    font-family: fontawesome;
}
    ...
    <div class="weui-popup__modal">
        <div class="weui-cells weui-cells_radio">
            ...
            <label class="weui-cell weui-check__label" for="x15">
                ...
                <div class="weui-cell__ft">
                    <input type="radio" name="radio1" class="weui-check" id="x15" value="5" data-des="前五">
                    <span class="weui-icon-checked"></span>
                </div>
            </label>
