 ...
 */
@Repository 
public class SupplierPurchaseDetailDaoImpl extends AbstractBaseDao<SupplierPurchaseDetail> implements SupplierPurchaseDetailDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_supplier_purchase_detail", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_supplier_purchase_detail", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_supplier_purchase_detail", type = Type.QUERY)
	@Override
	public PageResult<SupplierPurchaseDetail> findList(SupplierPurchaseDetail entity, Page page) throws Exception {
