 ...
 */
@Repository 
public class FxDrugReviewDaoImpl extends AbstractBaseDao<FxDrugReview> implements FxDrugReviewDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_drug_review", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_drug_review", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_drug_review", type = Type.QUERY)
	@Override
	public PageResult<FxDrugReview> findList(FxDrugReview entity, Page page) throws Exception {
