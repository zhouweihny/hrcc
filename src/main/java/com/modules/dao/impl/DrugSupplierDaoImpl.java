 ...
 */
@Repository 
public class DrugSupplierDaoImpl extends AbstractBaseDao<DrugSupplier> implements DrugSupplierDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_drug_supplier", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_drug_supplier", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_drug_supplier", type = Type.QUERY)
	@Override
	public PageResult<DrugSupplier> findList(DrugSupplier entity, Page page) throws Exception {
