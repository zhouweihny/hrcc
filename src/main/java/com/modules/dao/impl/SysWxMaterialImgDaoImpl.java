 ...
 */
@Repository 
public class SysWxMaterialImgDaoImpl extends AbstractBaseDao<SysWxMaterialImg> implements SysWxMaterialImgDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "sys_wx_material_img", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "sys_wx_material_img", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "sys_wx_material_img", type = Type.QUERY)
	@Override
	public PageResult<SysWxMaterialImg> findList(SysWxMaterialImg entity, Page page) throws Exception {
