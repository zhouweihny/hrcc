 ...
 */
@Repository 
public class PxsDaoImpl extends AbstractBaseDao<Pxs> implements PxsDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_pxs", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_pxs", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_pxs", type = Type.QUERY)
	@Override
	public PageResult<Pxs> findList(Pxs entity, Page page) throws Exception {
