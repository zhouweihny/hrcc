 ...
 */
@Repository 
public class CmsContentDaoImpl extends AbstractBaseDao<CmsContent> implements CmsContentDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "cms_content", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "cms_content", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "cms_content", type = Type.QUERY)
	@Override
	public PageResult<CmsContent> findList(CmsContent entity, Page page) throws Exception {
