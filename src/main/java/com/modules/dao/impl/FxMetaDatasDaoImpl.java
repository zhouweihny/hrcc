 ...
 */
@Repository 
public class FxMetaDatasDaoImpl extends AbstractBaseDao<FxMetaDatas> implements FxMetaDatasDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_meta_datas", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_meta_datas", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_meta_datas", type = Type.QUERY)
	@Override
	public PageResult<FxMetaDatas> findList(FxMetaDatas entity, Page page) throws Exception {
