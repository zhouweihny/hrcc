 ...
 */
@Repository 
public class DrugikwordsDaoImpl extends AbstractBaseDao<Drugikwords> implements DrugikwordsDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_drugikwords", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_drugikwords", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_drugikwords", type = Type.QUERY)
	@Override
	public PageResult<Drugikwords> findList(Drugikwords entity, Page page) throws Exception {
