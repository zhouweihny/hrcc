 ...
 */
@Repository 
public class SupplierPurchaseDaoImpl extends AbstractBaseDao<SupplierPurchase> implements SupplierPurchaseDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_supplier_purchase", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_supplier_purchase", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_supplier_purchase", type = Type.QUERY)
	@Override
	public PageResult<SupplierPurchase> findList(SupplierPurchase entity, Page page) throws Exception {
