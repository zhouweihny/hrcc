 ...
 */
@Repository 
public class AccesstokenDaoImpl extends AbstractBaseDao<Accesstoken> implements AccesstokenDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_accesstoken", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_accesstoken", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_accesstoken", type = Type.QUERY)
	@Override
	public PageResult<Accesstoken> findList(Accesstoken entity, Page page) throws Exception {
