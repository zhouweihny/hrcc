 ...
 */
@Repository 
public class FxComnameTreeFactoryDaoImpl extends AbstractBaseDao<FxComnameTreeFactory> implements FxComnameTreeFactoryDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_comname_tree_factory", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_comname_tree_factory", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_comname_tree_factory", type = Type.QUERY)
	@Override
	public PageResult<FxComnameTreeFactory> findList(FxComnameTreeFactory entity, Page page) throws Exception {
