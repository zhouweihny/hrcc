 ...
 */
@Repository 
public class SysDictDaoImpl extends AbstractBaseDao<SysDict> implements SysDictDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "sys_dict", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "sys_dict", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "sys_dict", type = Type.QUERY)
	@Override
	public PageResult<SysDict> findList(SysDict entity, Page page) throws Exception {
