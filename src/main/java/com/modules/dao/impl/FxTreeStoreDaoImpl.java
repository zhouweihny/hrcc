 ...
 */
@Repository 
public class FxTreeStoreDaoImpl extends AbstractBaseDao<FxTreeStore> implements FxTreeStoreDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_tree_store", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_tree_store", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_tree_store", type = Type.QUERY)
	@Override
	public PageResult<FxTreeStore> findList(FxTreeStore entity, Page page) throws Exception {
