 ...
 */
@Repository 
public class SdrugDaoImpl extends AbstractBaseDao<Sdrug> implements SdrugDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_sdrug", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_sdrug", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_sdrug", type = Type.QUERY)
	@Override
	public PageResult<Sdrug> findList(Sdrug entity, Page page) throws Exception {
