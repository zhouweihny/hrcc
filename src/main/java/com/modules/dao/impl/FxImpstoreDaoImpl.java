 ...
 */
@Repository 
public class FxImpstoreDaoImpl extends AbstractBaseDao<FxImpstore> implements FxImpstoreDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_impstore", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_impstore", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_impstore", type = Type.QUERY)
	@Override
	public PageResult<FxImpstore> findList(FxImpstore entity, Page page) throws Exception {
