 ...
 */
@Repository 
public class SysImgDaoImpl extends AbstractBaseDao<SysImg> implements SysImgDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "sys_img", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "sys_img", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "sys_img", type = Type.QUERY)
	@Override
	public PageResult<SysImg> findList(SysImg entity, Page page) throws Exception {
