 ...
 */
@Repository 
public class PointDaoImpl extends AbstractBaseDao<Point> implements PointDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_point", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_point", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_point", type = Type.QUERY)
	@Override
	public PageResult<Point> findList(Point entity, Page page) throws Exception {
