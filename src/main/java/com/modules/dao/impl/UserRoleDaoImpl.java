...
public class UserRoleDaoImpl extends AbstractBaseDao<UserRole> implements UserRoleDao {
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_user_role", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_user_role", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_user_role", type = Type.QUERY)
	@Override
	public PageResult<UserRole> findList(UserRole entity, Page page) throws Exception {
