 ...
 */
@Repository 
public class KeywordsDaoImpl extends AbstractBaseDao<Keywords> implements KeywordsDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_keywords", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_keywords", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_keywords", type = Type.QUERY)
	@Override
	public PageResult<Keywords> findList(Keywords entity, Page page) throws Exception {
