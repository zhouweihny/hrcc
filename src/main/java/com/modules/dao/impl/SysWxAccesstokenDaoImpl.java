 ...
 */
@Repository 
public class SysWxAccesstokenDaoImpl extends AbstractBaseDao<SysWxAccesstoken> implements SysWxAccesstokenDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "sys_wx_accesstoken", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "sys_wx_accesstoken", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "sys_wx_accesstoken", type = Type.QUERY)
	@Override
	public PageResult<SysWxAccesstoken> findList(SysWxAccesstoken entity, Page page) throws Exception {
