 ...
 */
@Repository 
public class SysRoleMenuDaoImpl extends AbstractBaseDao<SysRoleMenu> implements SysRoleMenuDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "sys_role_menu", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "sys_role_menu", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "sys_role_menu", type = Type.QUERY)
	@Override
	public PageResult<SysRoleMenu> findList(SysRoleMenu entity, Page page) throws Exception {
