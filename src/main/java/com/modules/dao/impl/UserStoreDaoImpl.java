 ...
 */
@Repository 
public class UserStoreDaoImpl extends AbstractBaseDao<UserStore> implements UserStoreDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_user_store", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_user_store", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_user_store", type = Type.QUERY)
	@Override
	public PageResult<UserStore> findList(UserStore entity, Page page) throws Exception {
