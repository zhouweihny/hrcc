 ...
 */
@Repository 
public class FxComnameZbDaoImpl extends AbstractBaseDao<FxComnameZb> implements FxComnameZbDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_comname_zb", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_comname_zb", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_comname_zb", type = Type.QUERY)
	@Override
	public PageResult<FxComnameZb> findList(FxComnameZb entity, Page page) throws Exception {
