 ...
 */
@Repository 
public class FxSaleFileDaoImpl extends AbstractBaseDao<FxSaleFile> implements FxSaleFileDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_sale_file", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_sale_file", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_sale_file", type = Type.QUERY)
	@Override
	public PageResult<FxSaleFile> findList(FxSaleFile entity, Page page) throws Exception {
