 ...
 */
@Repository 
public class AutocompareDaoImpl extends AbstractBaseDao<Autocompare> implements AutocompareDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_autocompare", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_autocompare", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_autocompare", type = Type.QUERY)
	@Override
	public PageResult<Autocompare> findList(Autocompare entity, Page page) throws Exception {
