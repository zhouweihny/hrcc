 ...
 */
@Repository 
public class FxLhyydcDaoImpl extends AbstractBaseDao<FxLhyydc> implements FxLhyydcDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_lhyydc", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_lhyydc", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_lhyydc", type = Type.QUERY)
	@Override
	public PageResult<FxLhyydc> findList(FxLhyydc entity, Page page) throws Exception {
