 ...
 */
@Repository 
public class FxSaleMonthDaoImpl extends AbstractBaseDao<FxSaleMonth> implements FxSaleMonthDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_sale_month", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_sale_month", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_sale_month", type = Type.QUERY)
	@Override
	public PageResult<FxSaleMonth> findList(FxSaleMonth entity, Page page) throws Exception {
