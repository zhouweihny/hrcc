 ...
 */
@Repository 
public class FxMetaDaoImpl extends AbstractBaseDao<FxMeta> implements FxMetaDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_meta", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_meta", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_meta", type = Type.QUERY)
	@Override
	public PageResult<FxMeta> findList(FxMeta entity, Page page) throws Exception {
