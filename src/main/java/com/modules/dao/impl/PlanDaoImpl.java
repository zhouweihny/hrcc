 ...
 */
@Repository 
public class PlanDaoImpl extends AbstractBaseDao<Plan> implements PlanDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_plan", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_plan", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_plan", type = Type.QUERY)
	@Override
	public PageResult<Plan> findList(Plan entity, Page page) throws Exception {
