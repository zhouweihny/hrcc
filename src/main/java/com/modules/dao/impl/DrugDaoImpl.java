 ...
 */
@Repository 
public class DrugDaoImpl extends AbstractBaseDao<Drug> implements DrugDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_drug", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_drug", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_drug", type = Type.QUERY)
	@Override
	public PageResult<Drug> findList(Drug entity, Page page) throws Exception {
