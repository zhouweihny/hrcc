 ...
 */
@Repository
public class BillDaoImpl extends AbstractBaseDao<Bill> implements BillDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_bill", type = Type.UPDATE)
	@Override
	public void save(Bill entity) throws Exception {
		entity.setNo(OrderNoUtil.getBillNo());
		super.save(entity);
	}
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_bill", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_bill", type = Type.QUERY)
	@Override
	public PageResult<Bill> findList(Bill entity, Page page) throws Exception {
