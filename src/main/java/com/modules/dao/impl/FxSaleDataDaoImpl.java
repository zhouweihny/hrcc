 ...
 */
@Repository 
public class FxSaleDataDaoImpl extends AbstractBaseDao<FxSaleData> implements FxSaleDataDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_sale_data", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_sale_data", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_sale_data", type = Type.QUERY)
	@Override
	public PageResult<FxSaleData> findList(FxSaleData entity, Page page) throws Exception {
