 ...
 */
@Repository 
public class FxMethodDaoImpl extends AbstractBaseDao<FxMethod> implements FxMethodDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_method", type = Type.UPDATE)
	@Override
	public void save(FxMethod entity) throws Exception {
		super.save(entity);
	}
	...
	@MyCache(value = "fx_method", type = Type.UPDATE)
	@Override
	public void save(List<FxMethod> entities) throws Exception {
		super.save(entities);
	}
	...
	@MyCache(value = "fx_method", type = Type.UPDATE)
	@Override
	public void update(FxMethod entity) throws Exception {
		super.update(entity);
	}
	...
	@MyCache(value = "fx_method", type = Type.UPDATE)
	@Override
	public void update(FxMethod newEntity, FxMethod oldEntity) throws Exception {
	...
	@MyCache(value = "fx_method", type = Type.UPDATE)
	@Override
	public void delete(FxMethod entity) throws Exception {
		super.delete(entity);
	}
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_method", type = Type.QUERY)
	@Override
	public FxMethod findObject(FxMethod entity) throws Exception {
	...
	@MyCache(value = "fx_method", type = Type.QUERY)
	@Override
	public List<FxMethod> findList(FxMethod entity) throws Exception {
	...
	@MyCache(value = "fx_method", type = Type.QUERY)
	@Override
	public PageResult<FxMethod> findList(FxMethod entity, Page page) throws Exception {
