 ...
 */
@Repository 
public class DosageformDaoImpl extends AbstractBaseDao<Dosageform> implements DosageformDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_dosageform", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_dosageform", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_dosageform", type = Type.QUERY)
	@Override
	public PageResult<Dosageform> findList(Dosageform entity, Page page) throws Exception {
