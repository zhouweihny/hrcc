...
public class CatalogDaoImpl extends AbstractBaseDao<Catalog> implements CatalogDao {
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_catalog", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_catalog", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_catalog", type = Type.QUERY)
	@Override
	public PageResult<Catalog> findList(Catalog entity, Page page) throws Exception {
