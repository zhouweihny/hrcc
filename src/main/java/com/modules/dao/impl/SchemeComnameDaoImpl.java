 ...
 */
@Repository 
public class SchemeComnameDaoImpl extends AbstractBaseDao<SchemeComname> implements SchemeComnameDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_scheme_comname", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_scheme_comname", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_scheme_comname", type = Type.QUERY)
	@Override
	public PageResult<SchemeComname> findList(SchemeComname entity, Page page) throws Exception {
