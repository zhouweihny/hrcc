 ...
 */
@Repository 
public class DrugTempDaoImpl extends AbstractBaseDao<DrugTemp> implements DrugTempDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_drug_temp", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_drug_temp", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_drug_temp", type = Type.QUERY)
	@Override
	public PageResult<DrugTemp> findList(DrugTemp entity, Page page) throws Exception {
