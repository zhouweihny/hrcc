 ...
 */
@Repository 
public class ComwordsDaoImpl extends AbstractBaseDao<Comwords> implements ComwordsDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_comwords", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_comwords", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_comwords", type = Type.QUERY)
	@Override
	public PageResult<Comwords> findList(Comwords entity, Page page) throws Exception {
