 ...
 */
@Repository 
public class SysWxMsgDaoImpl extends AbstractBaseDao<SysWxMsg> implements SysWxMsgDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "sys_wx_msg", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "sys_wx_msg", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "sys_wx_msg", type = Type.QUERY)
	@Override
	public PageResult<SysWxMsg> findList(SysWxMsg entity, Page page) throws Exception {
