 ...
 */
@Repository 
public class DrugDrugDelDaoImpl extends AbstractBaseDao<DrugDrugDel> implements DrugDrugDelDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_drug_drug_del", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_drug_drug_del", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_drug_drug_del", type = Type.QUERY)
	@Override
	public PageResult<DrugDrugDel> findList(DrugDrugDel entity, Page page) throws Exception {
