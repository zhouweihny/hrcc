 ...
 */
@Repository 
public class FxOrderfxDaoImpl extends AbstractBaseDao<FxOrderfx> implements FxOrderfxDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_orderfx", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_orderfx", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_orderfx", type = Type.QUERY)
	@Override
	public PageResult<FxOrderfx> findList(FxOrderfx entity, Page page) throws Exception {
