 ...
 */
@Repository 
public class SpaceDaoImpl extends AbstractBaseDao<Space> implements SpaceDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_space", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_space", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_space", type = Type.QUERY)
	@Override
	public PageResult<Space> findList(Space entity, Page page) throws Exception {
