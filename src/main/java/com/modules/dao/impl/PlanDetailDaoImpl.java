 ...
 */
@Repository 
public class PlanDetailDaoImpl extends AbstractBaseDao<PlanDetail> implements PlanDetailDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_plan_detail", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_plan_detail", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_plan_detail", type = Type.QUERY)
	@Override
	public PageResult<PlanDetail> findList(PlanDetail entity, Page page) throws Exception {
