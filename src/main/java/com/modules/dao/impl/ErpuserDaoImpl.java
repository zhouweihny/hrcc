 ...
 */
@Repository 
public class ErpuserDaoImpl extends AbstractBaseDao<Erpuser> implements ErpuserDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_erpuser", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_erpuser", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_erpuser", type = Type.QUERY)
	@Override
	public PageResult<Erpuser> findList(Erpuser entity, Page page) throws Exception {
