 ...
 */
@Repository 
public class SysWxDaoImpl extends AbstractBaseDao<SysWx> implements SysWxDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "sys_wx", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "sys_wx", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "sys_wx", type = Type.QUERY)
	@Override
	public PageResult<SysWx> findList(SysWx entity, Page page) throws Exception {
