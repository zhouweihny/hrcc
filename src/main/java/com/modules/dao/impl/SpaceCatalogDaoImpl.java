 ...
 */
@Repository 
public class SpaceCatalogDaoImpl extends AbstractBaseDao<SpaceCatalog> implements SpaceCatalogDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_space_catalog", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_space_catalog", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_space_catalog", type = Type.QUERY)
	@Override
	public PageResult<SpaceCatalog> findList(SpaceCatalog entity, Page page) throws Exception {
