 ...
 */
@Repository 
public class FactoryKeywordDaoImpl extends AbstractBaseDao<FactoryKeyword> implements FactoryKeywordDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_factory_keyword", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_factory_keyword", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_factory_keyword", type = Type.QUERY)
	@Override
	public PageResult<FactoryKeyword> findList(FactoryKeyword entity, Page page) throws Exception {
