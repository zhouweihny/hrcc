 ...
 */
@Repository 
public class SysDictdataDaoImpl extends AbstractBaseDao<SysDictdata> implements SysDictdataDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "sys_dictdata", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "sys_dictdata", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "sys_dictdata", type = Type.QUERY)
	@Override
	public PageResult<SysDictdata> findList(SysDictdata entity, Page page) throws Exception {
