 ...
 */
@Repository 
public class FxTreeDaoImpl extends AbstractBaseDao<FxTree> implements FxTreeDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_tree", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_tree", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_tree", type = Type.QUERY)
	@Override
	public PageResult<FxTree> findList(FxTree entity, Page page) throws Exception {
