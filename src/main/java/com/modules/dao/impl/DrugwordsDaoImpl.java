 ...
 */
@Repository 
public class DrugwordsDaoImpl extends AbstractBaseDao<Drugwords> implements DrugwordsDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_drugwords", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_drugwords", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_drugwords", type = Type.QUERY)
	@Override
	public PageResult<Drugwords> findList(Drugwords entity, Page page) throws Exception {
