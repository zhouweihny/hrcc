 ...
 */
@Repository 
public class UserWxDaoImpl extends AbstractBaseDao<UserWx> implements UserWxDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_user_wx", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_user_wx", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_user_wx", type = Type.QUERY)
	@Override
	public PageResult<UserWx> findList(UserWx entity, Page page) throws Exception {
