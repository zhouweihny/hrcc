 ...
 */
@Repository 
public class FxTreeTaskDaoImpl extends AbstractBaseDao<FxTreeTask> implements FxTreeTaskDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_tree_task", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_tree_task", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_tree_task", type = Type.QUERY)
	@Override
	public PageResult<FxTreeTask> findList(FxTreeTask entity, Page page) throws Exception {
