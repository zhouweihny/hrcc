 ...
 */
@Repository 
public class FxBudgettableDaoImpl extends AbstractBaseDao<FxBudgettable> implements FxBudgettableDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_budgettable", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_budgettable", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_budgettable", type = Type.QUERY)
	@Override
	public PageResult<FxBudgettable> findList(FxBudgettable entity, Page page) throws Exception {
