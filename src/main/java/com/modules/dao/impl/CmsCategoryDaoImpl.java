 ...
 */
@Repository 
public class CmsCategoryDaoImpl extends AbstractBaseDao<CmsCategory> implements CmsCategoryDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "cms_category", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "cms_category", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "cms_category", type = Type.QUERY)
	@Override
	public PageResult<CmsCategory> findList(CmsCategory entity, Page page) throws Exception {
