 ...
 */
@Repository 
public class DrugPromotionDaoImpl extends AbstractBaseDao<DrugPromotion> implements DrugPromotionDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_drug_promotion", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_drug_promotion", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_drug_promotion", type = Type.QUERY)
	@Override
	public PageResult<DrugPromotion> findList(DrugPromotion entity, Page page) throws Exception {
