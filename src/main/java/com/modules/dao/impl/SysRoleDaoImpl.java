...
public class SysRoleDaoImpl extends AbstractBaseDao<SysRole> implements SysRoleDao {
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "sys_role", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "sys_role", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "sys_role", type = Type.QUERY)
	@Override
	public PageResult<SysRole> findList(SysRole entity, Page page) throws Exception {
