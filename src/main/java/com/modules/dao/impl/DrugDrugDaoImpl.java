 ...
 */
@Repository 
public class DrugDrugDaoImpl extends AbstractBaseDao<DrugDrug> implements DrugDrugDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_drug_drug", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_drug_drug", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_drug_drug", type = Type.QUERY)
	@Override
	public PageResult<DrugDrug> findList(DrugDrug entity, Page page) throws Exception {
