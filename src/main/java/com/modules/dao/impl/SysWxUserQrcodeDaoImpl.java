 ...
 */
@Repository 
public class SysWxUserQrcodeDaoImpl extends AbstractBaseDao<SysWxUserQrcode> implements SysWxUserQrcodeDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "sys_wx_user_qrcode", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "sys_wx_user_qrcode", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "sys_wx_user_qrcode", type = Type.QUERY)
	@Override
	public PageResult<SysWxUserQrcode> findList(SysWxUserQrcode entity, Page page) throws Exception {
