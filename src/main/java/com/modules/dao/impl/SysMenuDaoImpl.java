 ...
 */
@Repository 
public class SysMenuDaoImpl extends AbstractBaseDao<SysMenu> implements SysMenuDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "sys_menu", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "sys_menu", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "sys_menu", type = Type.QUERY)
	@Override
	public PageResult<SysMenu> findList(SysMenu entity, Page page) throws Exception {
