 ...
 */
@Repository 
public class UserSupplierDaoImpl extends AbstractBaseDao<UserSupplier> implements UserSupplierDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_user_supplier", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_user_supplier", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_user_supplier", type = Type.QUERY)
	@Override
	public PageResult<UserSupplier> findList(UserSupplier entity, Page page) throws Exception {
