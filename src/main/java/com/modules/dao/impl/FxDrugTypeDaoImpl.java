 ...
 */
@Repository 
public class FxDrugTypeDaoImpl extends AbstractBaseDao<FxDrugType> implements FxDrugTypeDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 ...
	 */
	@Override
	public PageResult<FxDrugType> findList(FxDrugType entity, Page page) throws Exception {
