 ...
 */
@Repository 
public class FxDrugStoreDaoImpl extends AbstractBaseDao<FxDrugStore> implements FxDrugStoreDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_drug_store", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_drug_store", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_drug_store", type = Type.QUERY)
	@Override
	public PageResult<FxDrugStore> findList(FxDrugStore entity, Page page) throws Exception {
