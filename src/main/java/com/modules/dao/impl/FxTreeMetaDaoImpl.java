 ...
 */
@Repository 
public class FxTreeMetaDaoImpl extends AbstractBaseDao<FxTreeMeta> implements FxTreeMetaDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "fx_tree_meta", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "fx_tree_meta", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "fx_tree_meta", type = Type.QUERY)
	@Override
	public PageResult<FxTreeMeta> findList(FxTreeMeta entity, Page page) throws Exception {
