 ...
 */
@Repository 
public class SysWxMaterialTwDaoImpl extends AbstractBaseDao<SysWxMaterialTw> implements SysWxMaterialTwDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "sys_wx_material_tw", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "sys_wx_material_tw", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "sys_wx_material_tw", type = Type.QUERY)
	@Override
	public PageResult<SysWxMaterialTw> findList(SysWxMaterialTw entity, Page page) throws Exception {
