 ...
 */
@Repository 
public class SchemeDaoImpl extends AbstractBaseDao<Scheme> implements SchemeDao {
	/**
	 * 保存对象
	 * 
	 * @param entity
	 * @throws Exception
	 */
	@MyCache(value = "t_scheme", type = Type.UPDATE)
	@Override
	 ...
	 * @throws Exception
	 */
	@MyCache(value = "t_scheme", type = Type.QUERY)
	@Override
	...
	@MyCache(value = "t_scheme", type = Type.QUERY)
	@Override
	public PageResult<Scheme> findList(Scheme entity, Page page) throws Exception {
