...
public class AccesstokenController extends BaseController {
	...
	public Object save(Accesstoken accesstoken, HttpServletRequest request, HttpServletResponse response) {
		try {
			if (StringUtils.isEmpty(accesstoken.getId())) {
	...
	@ResponseBody
	public Object delete(Accesstoken accesstoken) {
		try {
	...
	@ResponseBody
	public Object gbyid(Accesstoken accesstoken) {
		ModelAndView modelAndView = new ModelAndView("accesstoken/info");
		try {
	  		if (!StringUtils.isEmpty(accesstoken.getId())) {
				Accesstoken data = accesstokenService.findObject(accesstoken);
	...
	@ResponseBody
	public Object pbyid(Accesstoken accesstoken) {
		try {
			Accesstoken data = accesstokenService.findObject(accesstoken);
	...
	public ModelAndView glist(HttpServletRequest request, HttpServletResponse response) {
		ModelAndView modelAndView = new ModelAndView("accesstoken/list");
		return modelAndView;
	}
	...
	public ModelAndView plist(HttpServletRequest request, HttpServletResponse response, String stype, String sfield, Integer currentPage, Integer pageSize) {
		ModelAndView modelAndView = new ModelAndView("accesstoken/table");
		try {
			...
			PageResult<Accesstoken> data = accesstokenService.findList(params, page);
