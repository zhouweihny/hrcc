...
@Component("planDirective")
public class PlanDirective implements TemplateDirectiveModel {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				...
				Plan	plan = planService.findObject(entity);
				if (plan == null)
					plan = new Plan();
				env.setVariable("plan", ObjectWrapper.DEFAULT_WRAPPER.wrap(plan));
			} catch (Exception e) {
