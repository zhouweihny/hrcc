...
@Component("fxMetaDirective")
public class FxMetaDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				FxMeta entity = new FxMeta();
				entity.setId(primarykey);
				FxMeta	fxMeta = fxMetaService.findObject(entity);
				if (fxMeta == null)
					fxMeta = new FxMeta();
				env.setVariable("fxMeta", ObjectWrapper.DEFAULT_WRAPPER.wrap(fxMeta));
			} catch (Exception e) {
