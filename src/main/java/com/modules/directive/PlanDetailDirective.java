...
@Component("planDetailDirective")
public class PlanDetailDirective implements TemplateDirectiveModel {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				...
				PlanDetail	planDetail = planDetailService.findObject(entity);
				if (planDetail == null)
					planDetail = new PlanDetail();
				env.setVariable("planDetail", ObjectWrapper.DEFAULT_WRAPPER.wrap(planDetail));
			} catch (Exception e) {
