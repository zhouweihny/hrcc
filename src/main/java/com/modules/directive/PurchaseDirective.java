...
@Component("purchaseDirective")
public class PurchaseDirective implements TemplateDirectiveModel {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				...
				Purchase	purchase = purchaseService.findObject(entity);
				if (purchase == null)
					purchase = new Purchase();
				env.setVariable("purchase", ObjectWrapper.DEFAULT_WRAPPER.wrap(purchase));
			} catch (Exception e) {
