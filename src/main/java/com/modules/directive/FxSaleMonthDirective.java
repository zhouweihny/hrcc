...
@Component("fxSaleMonthDirective")
public class FxSaleMonthDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				FxSaleMonth entity = new FxSaleMonth();
				entity.setId(primarykey);
				FxSaleMonth	fxSaleMonth = fxSaleMonthService.findObject(entity);
				if (fxSaleMonth == null)
					fxSaleMonth = new FxSaleMonth();
				env.setVariable("fxSaleMonth", ObjectWrapper.DEFAULT_WRAPPER.wrap(fxSaleMonth));
			} catch (Exception e) {
