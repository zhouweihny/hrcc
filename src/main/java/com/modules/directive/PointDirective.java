...
@Component("pointDirective")
public class PointDirective implements TemplateDirectiveModel {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				...
				Point	point = pointService.findObject(entity);
				if (point == null)
					point = new Point();
				env.setVariable("point", ObjectWrapper.DEFAULT_WRAPPER.wrap(point));
			} catch (Exception e) {
