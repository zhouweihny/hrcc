...
@Component("keywordsDirective")
public class KeywordsDirective implements TemplateDirectiveModel {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				...
				Keywords	keywords = keywordsService.findObject(entity);
				if (keywords == null)
					keywords = new Keywords();
				env.setVariable("keywords", ObjectWrapper.DEFAULT_WRAPPER.wrap(keywords));
			} catch (Exception e) {
