...
@Component("sysRoleMenuDirective")
public class SysRoleMenuDirective implements TemplateDirectiveModel {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				...
				SysRoleMenu	sysRoleMenu = sysRoleMenuService.findObject(entity);
				if (sysRoleMenu == null)
					sysRoleMenu = new SysRoleMenu();
				env.setVariable("sysRoleMenu", ObjectWrapper.DEFAULT_WRAPPER.wrap(sysRoleMenu));
			} catch (Exception e) {
