...
@Component("drugDrugDirective")
public class DrugDrugDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				DrugDrug entity = new DrugDrug();
				entity.setId(primarykey);
				DrugDrug	drugDrug = drugDrugService.findObject(entity);
				if (drugDrug == null)
					drugDrug = new DrugDrug();
				env.setVariable("drugDrug", ObjectWrapper.DEFAULT_WRAPPER.wrap(drugDrug));
			} catch (Exception e) {
