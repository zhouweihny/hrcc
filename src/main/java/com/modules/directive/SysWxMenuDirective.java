...
@Component("sysWxMenuDirective")
public class SysWxMenuDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				SysWxMenu entity = new SysWxMenu();
				entity.setId(primarykey);
				SysWxMenu	sysWxMenu = sysWxMenuService.findObject(entity);
				if (sysWxMenu == null)
					sysWxMenu = new SysWxMenu();
				env.setVariable("sysWxMenu", ObjectWrapper.DEFAULT_WRAPPER.wrap(sysWxMenu));
			} catch (Exception e) {
