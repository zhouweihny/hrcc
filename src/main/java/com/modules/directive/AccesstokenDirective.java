...
@Component("accesstokenDirective")
public class AccesstokenDirective implements TemplateDirectiveModel {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				...
				Accesstoken	accesstoken = accesstokenService.findObject(entity);
				if (accesstoken == null)
					accesstoken = new Accesstoken();
				env.setVariable("accesstoken", ObjectWrapper.DEFAULT_WRAPPER.wrap(accesstoken));
			} catch (Exception e) {
