...
@Component("sysWxAccesstokenDirective")
public class SysWxAccesstokenDirective implements TemplateDirectiveModel {
		  ...
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				...
				if (sysWxAccesstoken == null)
					sysWxAccesstoken = new SysWxAccesstoken();
				env.setVariable("sysWxAccesstoken", ObjectWrapper.DEFAULT_WRAPPER.wrap(sysWxAccesstoken));
			} catch (Exception e) {
