...
@Component("purchaseDetailDirective")
public class PurchaseDetailDirective implements TemplateDirectiveModel {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				...
				PurchaseDetail	purchaseDetail = purchaseDetailService.findObject(entity);
				if (purchaseDetail == null)
					purchaseDetail = new PurchaseDetail();
				env.setVariable("purchaseDetail", ObjectWrapper.DEFAULT_WRAPPER.wrap(purchaseDetail));
			} catch (Exception e) {
