...
@Component("userRoleDirective")
public class UserRoleDirective implements TemplateDirectiveModel {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				...
				UserRole	userRole = userRoleService.findObject(entity);
				if (userRole == null)
					userRole = new UserRole();
				env.setVariable("userRole", ObjectWrapper.DEFAULT_WRAPPER.wrap(userRole));
			} catch (Exception e) {
