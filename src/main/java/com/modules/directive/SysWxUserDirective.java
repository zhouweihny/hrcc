...
@Component("sysWxUserDirective")
public class SysWxUserDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				SysWxUser entity = new SysWxUser();
				entity.setId(primarykey);
				SysWxUser	sysWxUser = sysWxUserService.findObject(entity);
				if (sysWxUser == null)
					sysWxUser = new SysWxUser();
				env.setVariable("sysWxUser", ObjectWrapper.DEFAULT_WRAPPER.wrap(sysWxUser));
			} catch (Exception e) {
