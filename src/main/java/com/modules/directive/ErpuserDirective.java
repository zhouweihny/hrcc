...
@Component("erpuserDirective")
public class ErpuserDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				Erpuser entity = new Erpuser();
				entity.setId(primarykey);
				Erpuser	erpuser = erpuserService.findObject(entity);
				if (erpuser == null)
					erpuser = new Erpuser();
				env.setVariable("erpuser", ObjectWrapper.DEFAULT_WRAPPER.wrap(erpuser));
			} catch (Exception e) {
