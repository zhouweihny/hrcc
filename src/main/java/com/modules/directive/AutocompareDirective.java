...
@Component("autocompareDirective")
public class AutocompareDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				Autocompare entity = new Autocompare();
				entity.setId(primarykey);
				Autocompare	autocompare = autocompareService.findObject(entity);
				if (autocompare == null)
					autocompare = new Autocompare();
				env.setVariable("autocompare", ObjectWrapper.DEFAULT_WRAPPER.wrap(autocompare));
			} catch (Exception e) {
