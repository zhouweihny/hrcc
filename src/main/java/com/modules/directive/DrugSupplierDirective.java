...
@Component("drugSupplierDirective")
public class DrugSupplierDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				DrugSupplier entity = new DrugSupplier();
				entity.setId(primarykey);
				DrugSupplier	drugSupplier = drugSupplierService.findObject(entity);
				if (drugSupplier == null)
					drugSupplier = new DrugSupplier();
				env.setVariable("drugSupplier", ObjectWrapper.DEFAULT_WRAPPER.wrap(drugSupplier));
			} catch (Exception e) {
