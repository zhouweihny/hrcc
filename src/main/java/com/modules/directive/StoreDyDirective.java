...
@Component("storeDyDirective")
public class StoreDyDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				StoreDy entity = new StoreDy();
				entity.setId(primarykey);
				StoreDy	storeDy = storeDyService.findObject(entity);
				if (storeDy == null)
					storeDy = new StoreDy();
				env.setVariable("storeDy", ObjectWrapper.DEFAULT_WRAPPER.wrap(storeDy));
			} catch (Exception e) {
