...
@Component("sysImgDirective")
public class SysImgDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				SysImg entity = new SysImg();
				entity.setId(primarykey);
				SysImg	sysImg = sysImgService.findObject(entity);
				if (sysImg == null)
					sysImg = new SysImg();
				env.setVariable("sysImg", ObjectWrapper.DEFAULT_WRAPPER.wrap(sysImg));
			} catch (Exception e) {
