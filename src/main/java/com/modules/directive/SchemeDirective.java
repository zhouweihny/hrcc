...
@Component("schemeDirective")
public class SchemeDirective implements TemplateDirectiveModel {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				...
				Scheme	scheme = schemeService.findObject(entity);
				if (scheme == null)
					scheme = new Scheme();
				env.setVariable("scheme", ObjectWrapper.DEFAULT_WRAPPER.wrap(scheme));
			} catch (Exception e) {
