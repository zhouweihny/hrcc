...
@Component("drugDirective")
public class DrugDirective implements TemplateDirectiveModel {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				...
				Drug	drug = drugService.findObject(entity);
				if (drug == null)
					drug = new Drug();
				env.setVariable("drug", ObjectWrapper.DEFAULT_WRAPPER.wrap(drug));
			} catch (Exception e) {
