...
@Component("factoryDirective")
public class FactoryDirective implements TemplateDirectiveModel {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				...
				Factory	factory = factoryService.findObject(entity);
				if (factory == null)
					factory = new Factory();
				env.setVariable("factory", ObjectWrapper.DEFAULT_WRAPPER.wrap(factory));
			} catch (Exception e) {
