...
@Component("factoryKeywordDirective")
public class FactoryKeywordDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				FactoryKeyword entity = new FactoryKeyword();
				entity.setId(primarykey);
				FactoryKeyword	factoryKeyword = factoryKeywordService.findObject(entity);
				if (factoryKeyword == null)
					factoryKeyword = new FactoryKeyword();
				env.setVariable("factoryKeyword", ObjectWrapper.DEFAULT_WRAPPER.wrap(factoryKeyword));
			} catch (Exception e) {
