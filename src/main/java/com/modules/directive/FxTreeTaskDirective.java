...
@Component("fxTreeTaskDirective")
public class FxTreeTaskDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				FxTreeTask entity = new FxTreeTask();
				entity.setId(primarykey);
				FxTreeTask	fxTreeTask = fxTreeTaskService.findObject(entity);
				if (fxTreeTask == null)
					fxTreeTask = new FxTreeTask();
				env.setVariable("fxTreeTask", ObjectWrapper.DEFAULT_WRAPPER.wrap(fxTreeTask));
			} catch (Exception e) {
