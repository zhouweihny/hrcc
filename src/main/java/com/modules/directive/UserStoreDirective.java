...
@Component("userStoreDirective")
public class UserStoreDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				UserStore entity = new UserStore();
				entity.setId(primarykey);
				UserStore	userStore = userStoreService.findObject(entity);
				if (userStore == null)
					userStore = new UserStore();
				env.setVariable("userStore", ObjectWrapper.DEFAULT_WRAPPER.wrap(userStore));
			} catch (Exception e) {
