...
@Component("sysDictDirective")
public class SysDictDirective implements TemplateDirectiveModel {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				...
				SysDict	sysDict = sysDictService.findObject(entity);
				if (sysDict == null)
					sysDict = new SysDict();
				env.setVariable("sysDict", ObjectWrapper.DEFAULT_WRAPPER.wrap(sysDict));
			} catch (Exception e) {
