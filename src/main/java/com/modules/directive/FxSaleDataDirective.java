...
@Component("fxSaleDataDirective")
public class FxSaleDataDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				FxSaleData entity = new FxSaleData();
				entity.setId(primarykey);
				FxSaleData	fxSaleData = fxSaleDataService.findObject(entity);
				if (fxSaleData == null)
					fxSaleData = new FxSaleData();
				env.setVariable("fxSaleData", ObjectWrapper.DEFAULT_WRAPPER.wrap(fxSaleData));
			} catch (Exception e) {
