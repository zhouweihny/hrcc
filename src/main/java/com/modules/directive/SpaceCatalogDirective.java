...
@Component("spaceCatalogDirective")
public class SpaceCatalogDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				SpaceCatalog entity = new SpaceCatalog();
				entity.setId(primarykey);
				SpaceCatalog	spaceCatalog = spaceCatalogService.findObject(entity);
				if (spaceCatalog == null)
					spaceCatalog = new SpaceCatalog();
				env.setVariable("spaceCatalog", ObjectWrapper.DEFAULT_WRAPPER.wrap(spaceCatalog));
			} catch (Exception e) {
