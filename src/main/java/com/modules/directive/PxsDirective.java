...
@Component("pxsDirective")
public class PxsDirective implements TemplateDirectiveModel {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				...
				Pxs	pxs = pxsService.findObject(entity);
				if (pxs == null)
					pxs = new Pxs();
				env.setVariable("pxs", ObjectWrapper.DEFAULT_WRAPPER.wrap(pxs));
			} catch (Exception e) {
