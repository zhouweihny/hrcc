...
@Component("drugikwordsDirective")
public class DrugikwordsDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				Drugikwords entity = new Drugikwords();
				entity.setId(primarykey);
				Drugikwords	drugikwords = drugikwordsService.findObject(entity);
				if (drugikwords == null)
					drugikwords = new Drugikwords();
				env.setVariable("drugikwords", ObjectWrapper.DEFAULT_WRAPPER.wrap(drugikwords));
			} catch (Exception e) {
