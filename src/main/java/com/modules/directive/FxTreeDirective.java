...
@Component("fxTreeDirective")
public class FxTreeDirective implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		if(params.containsKey("id")){
		  java.lang.String  primarykey =  ((TemplateScalarModel) params.get("id")).getAsString();
			try {
				FxTree entity = new FxTree();
				entity.setId(primarykey);
				FxTree	fxTree = fxTreeService.findObject(entity);
				if (fxTree == null)
					fxTree = new FxTree();
				env.setVariable("fxTree", ObjectWrapper.DEFAULT_WRAPPER.wrap(fxTree));
			} catch (Exception e) {
