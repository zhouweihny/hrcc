 ...
 * 
 * @author Du.Jun
 * <b>功能：</b>CmsContent<br>
 */
@com.commons.annotation.Relation("cms_content")
public class CmsContent implements Serializable {
    ...
    @com.commons.annotation.Column(value="categoryid")
	private  java.lang.String   categoryid; //categoryid   
