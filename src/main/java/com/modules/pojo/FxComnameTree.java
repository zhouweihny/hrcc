...
/**
 * 
 * @author Du.Jun <b>功能：</b>FxComnameTree<br>
 */
@com.commons.annotation.Relation("fx_comname_tree")
public class FxComnameTree implements Serializable {
	...
	private java.lang.Boolean fwflag; // fwflag
	...
	public java.lang.Boolean getFwflag() {
		return fwflag;
	}

	public void setFwflag(java.lang.Boolean fwflag) {
		this.fwflag = fwflag;
	}
